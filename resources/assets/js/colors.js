 ...
 * @returns String
 */
 const resolveElementProperty = (element, property) => document.defaultView.getComputedStyle(element, null)[property];
 ...
 export function rgbFromCssVariable(variable) {
     return hex2rgb(getComputedStyle(document.documentElement).getPropertyValue(variable).replace('#', ''))
 };
