 ...
 *
 * This is a copy of https://www.github.com/orestbida/cookieconsent with minor adjustments for ARK.io-related projects
 */
(function(){
    'use strict';
    /**
    ...
    var CookieConsent = function(root){
        ...
        var _setConfig = function(_user_config){
            ...
            if(typeof user_config['avoid_explicit_domain'] === "boolean")
                _config.avoid_explicit_domain = user_config['avoid_explicit_domain'];
        ...
        var _setCookie = function(name, value) {
            ...
            if(_config.avoid_explicit_domain === false || window.location.hostname.indexOf(".") > -1){
