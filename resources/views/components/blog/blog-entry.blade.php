...
<a href="{{ $article->url() }}" class="focus-indicator flex h-full flex-1">
    <div
        ...
        <div class="flex flex-1 items-center border-t border-theme-secondary-300 p-10">
            <div>
                <div class="mb-5 flex space-x-3 text-sm font-semibold text-theme-secondary-500">
