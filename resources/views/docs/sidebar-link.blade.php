...
@if ($topLevel)
    <div class="sidebar-link">
        ...
        <div class="h-13 w-full lg:h-auto">
            @if ($topBorder)
                <div class="flex">
                    <x-ark-divider :class="Arr::toCssClasses(['mx-8 lg:ml-5 lg:mr-0', 'hidden lg:block' => $onDocs])" />
                </div>
            @endif
            ...
            @unless ($borderless)
                <div class="flex">
                    <x-ark-divider :class="Arr::toCssClasses([
...
@else
    @if (count($children) === 0)
        <div class="sidebar-link relative -mr-5 border-l border-theme-secondary-300 pr-0 lg:mx-0">
            <div @class([
    ...
    @else
        <div class="-mr-5 ml-5 flex border-l border-theme-secondary-300 pr-0 lg:mx-0">
            <div class="flex-1">
                <div class="flex w-full items-center justify-between space-x-3 py-3 pl-5 text-left">
