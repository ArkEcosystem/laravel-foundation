<x-ark-js-modal init name="alertModal" :title="trans('ui::markdown.modals.alert.title')" width-class="max-w-lg">
    @slot('description')
        <form id="alertModalForm" @submit.prevent="Livewire.dispatch('alertModal', $event)" class="space-y-4">
            <x-ark-select name="type" :label="trans('ui::markdown.modals.alert.form.type')">
            ...
            <x-ark-input type="text" name="text" :label="trans('ui::markdown.modals.alert.form.text')" class="w-full" />
        </form>
    @endslot
