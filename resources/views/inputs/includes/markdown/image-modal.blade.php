        ...
        <form id="imageModalForm" @submit.prevent="Livewire.emit('imageModal', $event)">
            ...
            <template x-if="source === 'file'">
                <div class="relative w-full h-36">
                    <div class="p-1.5 w-full h-full rounded-xl border-2 border-dashed border-theme-primary-100 dark:border-theme-secondary-800 focus-within:border-theme-primary-500">
