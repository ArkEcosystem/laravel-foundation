...
<div @class([
    ...
    <div @class([
        ...
        @include('ark::inputs.includes.markdown.button', [
            'name' => 'undo',
            'iconName' => 'arrows.arrow-rotate-left',
            'onClick' => 'undo',
        ])

        @include('ark::inputs.includes.markdown.button', [
            'name' => 'redo',
            'iconName' => 'arrows.arrow-rotate-right',
            'onClick' => 'redo',
        ])
        ...
        @unless ($toolbar === 'basic')
            @include('ark::inputs.includes.markdown.button', [
                'name' => 'inline_code',
                'iconName' => 'programming-browser-1',
                'onClick' => 'code',
                'nodeName' => 'code',
            ])
            ...
            @include('ark::inputs.includes.markdown.button', [
                'name' => 'simplecast',
                'iconName' => 'social-music-podcast',
                'onClick' => 'embedPodcast',
            ])

            @include('ark::inputs.includes.markdown.button', [
                'name' => 'link_collection',
                'iconName' => 'app-window-link',
            ...
            @include('ark::inputs.includes.markdown.button', [
                'name' => 'page_reference',
                'iconName' => 'page-reference',
                'onClick' => 'pageReference',
            ])
        @endunless

        @unless ($mobile)
            <div class="markdown-navbar-more ml-auto flex items-center" style="display: none">
    ...
    @unless ($mobile)
        <span
            class="relative z-0 -mt-0.5 block h-0 border-b border-theme-secondary-200 dark:border-theme-secondary-700"></span>
    @endunless
</div>
