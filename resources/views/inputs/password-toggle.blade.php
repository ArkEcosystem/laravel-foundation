<div class="{{ $class ?? '' }}" x-data="{
    ...
    <div class="input-group">
        ...
        <div class="input-wrapper">
            {{-- input --}}
            <input x-ref="password-input" :type="type" id="{{ $id ?? $name }}" name="{{ $name }}"
                @class([
                    $inputClass ?? '',
                    'input-text shifted',
                ...
                @if ($autofocus ?? false) autofocus @endif @if ($readonly ?? false) readonly @endif
                @if ($required ?? false) required @endif
                autocomplete="{{ $autocomplete ?? 'current-password' }}" @keydown="$dispatch('typing')" />
            ...
            <button type="button" @class([
                ...
                <span x-show="!show"><x-ark-icon name="eye" /></span>
                <span x-show="show" x-cloak><x-ark-icon name="eye-slash" /></span>
            </button>
