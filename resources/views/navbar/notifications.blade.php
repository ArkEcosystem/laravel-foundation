<div class="{{ $class ?? '' }}" @click="Livewire.dispatch('markNotificationsAsSeen')"
    dusk="navigation-notifications-icon">
    <x-ark-dropdown wrapper-class="mx-1 md:relative" dropdown-classes="mt-8 md:px-0 px-8 {{ $dropdownClasses ?? '' }}"
        ...
        <x-slot name="button">
            <x-ark-icon name="bell"
                class="transition-default text-theme-secondary-600 group-hover:text-theme-primary-700 dark:group-hover:text-theme-secondary-100" />
