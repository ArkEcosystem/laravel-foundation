<div class="{{ $class ?? ''}}" @click="livewire.emit('markNotificationsAsSeen')" dusk="navigation-notifications-icon">
    <x-ark-dropdown
        ...
        button-class="relative py-3 px-4 rounded transition-default group hover:bg-theme-primary-100 dark:text-theme-secondary-600 dark:hover:text-theme-secondary-100 dark:hover:bg-theme-secondary-800"
        dropdown-content-classes="bg-white dark:bg-theme-secondary-800 dark:text-theme-secondary-200 rounded-xl shadow-2xl"
    >
        <x-slot name="button">
            <x-ark-icon name="notification" class="transition-default text-theme-secondary-600 group-hover:text-theme-primary-700 dark:group-hover:text-theme-secondary-100" />
