@if ($type === 'success')
    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full bg-theme-success-200">
        <x-ark-icon name="checkmark" size="xs" class="text-theme-success-500" />
    </div>
...
@elseif ($type === 'running')
    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full bg-theme-warning-100">
        <x-ark-icon name="update" size="xs" class="text-theme-warning-900 animation-spin" />
    </div>
@elseif ($type === 'updated')
    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full bg-theme-warning-100">
        <x-ark-icon name="update" size="xs" class="text-theme-warning-900" />
    </div>
@elseif ($type === 'active')
